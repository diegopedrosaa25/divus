        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="well bs-component">
              ...
              <?php
              // Criar um array vazio com todos campos do formulario
              $dados = [
                'nome' => '',
                'email' => '',
                'senha' => '',
              ...
              if(isset($_POST['usuario'])){
                ...
                $dados['senha_confirmacao'] = $_POST['usuario']['senha_confirmacao'];
                 ...
                 if(count($errors) == 0){
                  ...
                  // Dados para inserção conforme definimos na classe Database
                  $insert = [
                    'nome' => $dados['nome'],
                    'email' => $dados['email'],
                    'senha' => md5($dados['senha']), // Criptografando a senha do usuario
                  ];

                  // Caso seja inserido será enviado para a pagina principal com a mensagem de sucesso
                  if($db->insert($insert)){
                    // Variavel de sessão, para utilizala e necessario executar o metodo que está
                    // na linha 10
              ...
              <!--
                 Criar formulário com os campos necessários para incluir no banco de dados
                 Definir o method como POST, e remover o action ou deixar ele vazio
                 para enviar os dados via POST para o proprio formulário
               -->
              <form class="form-horizontal" method="post" autocomplete="off">
                ...
                <fieldset>
                  ...
                  <!-- 
                     Criar um campo adicional que servirá para confirmar a senha
                     Este campo não irá ser persistido no banco de dados, existirá somente no formulário
                  -->
                  <div class="form-group">
